    ...
    >
      ...
      <List>
        ...
        <ListItem
          ...
          onClick={() => {
            window.scroll(0, 0);
            props.router.push("/articles/666c1c7dad6166e10de349d4");
            props.setValue(0);
            props.setToggle(!props.toggle);
          }}
        >
        ...
        <ListItem
          ...
          onClick={() => {
            window.scroll(0, 0);
            props.router.push("/articles/666c1f2ead6166e10de349d5");
            props.setValue(0);
            props.setToggle(!props.toggle);
          }}
        >
        ...
        <ListItem
          ...
          onClick={() => {
            window.scroll(0, 0);
            props.router.push("/articles/666d578ca47c55a489719a16");
            props.setValue(0);
            props.setToggle(!props.toggle);
          }}
        >
