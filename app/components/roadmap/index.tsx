      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-20">
            ...
            <Typography variant="h2" className="text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 mb-6">
              Centichain Roadmap
            </Typography>
            <Typography variant="h6" className="text-gray-400 max-w-3xl mx-auto text-lg">
              Our ambitious journey to revolutionize blockchain technology through innovation, security, and community-driven development
            </Typography>
          </motion.div>
              ...
              >
                <div className="flex flex-col md:flex-row md:items-start gap-8">
                  <div className="md:w-1/4">
                    <Typography variant="h5" className="text-3xl font-bold bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text text-transparent mb-2">
                      {phase.year}
                    </Typography>
                    ...
                    <div className="space-y-6 relative">
                      ...
                      {phase.items.map((item, index) => (
                        ...
                        >
                          ...
                          <Typography className="text-gray-300 text-lg pl-4">
                            {item.text}
                          </Typography>
                        </motion.div>
                      ))}
