  ...
  const downloadOptions = [
    {
      icon: SiWindows,
      text: "Windows",
      link: "https://centichain.org/downloads/updates/windows/x64/v0.22.5/Centichain_0.22.5_x64_en-US.msi",
      available: true,
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center space-y-4 md:space-y-6">
            <Typography variant="body1" className="text-sm md:text-base text-gray-400">
              Latest Release: <span className="text-gray-300 font-semibold">Version 0.22.5</span>
            </Typography>
