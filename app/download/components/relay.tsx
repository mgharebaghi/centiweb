    ...
    <div id="relay-section" className="h-screen flex flex-col justify-center">
      <Box className="bg-gradient-to-b from-gray-900 to-gray-800 h-full flex items-center">
        <Container maxWidth="lg" className="text-center">
          <Typography
            variant="h2"
            className="text-gray-100 mb-4 sm:mb-6 md:mb-8 font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl"
          >
            Run a Centichain Relay Node
          </Typography>
          <Typography
            variant="h5"
            className="text-gray-300 mb-6 sm:mb-8 md:mb-12 text-base sm:text-lg md:text-xl lg:text-2xl"
          >
          ...
          <Typography
            variant="body2"
            className="text-gray-400 mt-6 sm:mt-8 md:mt-12 text-xs sm:text-sm"
          >
            Relay Node Version: 1.0.0
          </Typography>
          <Typography
            variant="body2"
            className="text-gray-500 mt-2 sm:mt-4 mb-4 sm:mb-6 md:mb-8 text-xs sm:text-sm"
          >
            By running a Relay Node, you contribute to the network&apos;s stability
            and earn rewards.
          </Typography>
          <Button
            variant="contained"
